...
const textArray = ["Web Designer", "Full Stack Developer", "Frontend Developer", "Backend Developer", "Youtuber"];
...
function typeEffect() {
    ...
    if (!isDeleting && charIndex === currentText.length) {
        ...
        return;
    }else if (isDeleting && charIndex === 0) {           //if deleting is finished and charIndex is 0 
